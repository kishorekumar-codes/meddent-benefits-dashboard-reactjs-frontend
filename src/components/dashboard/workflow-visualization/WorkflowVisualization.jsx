...
import { capitalizeFirstLetter, stepColors } from "../../../utils/tools";
    ...
    <div className="card">
      ...
      <div className="workflow-timeline">
        {WorkFlowSteps.map((step, index) => {
          ...
          const isInQuery = step.status === "query";
              ...
              <div className={`workflow-card ${step.status}`}>
                ...
                <div className="workflow-card-right">
                  ...
                  <span className={`workflow-badge ${step.status}`}>
                    {capitalizeFirstLetter(step.status)}
                  </span>
                </div>
              </div>
            </div>
